...
Class database {
	...
	/*Función encargada de crear, si es necesario, el objeto.Esta es
	 *  la función que debemos llamar desde fuera de la clase para
	 *   instanciar el objeto,y así, poder utilizar sus métodos*/
